...
export function ThemeIcon({ active = false }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="none">
      <path
        className={`${active ? "fill-white" : "fill-white"}`}
...
export function Loader() {
  return (
    <svg
      ...
      viewBox="0 0 54 20"
    >
      <circle cx="6" cy="10" r="6" className="fill-black">
        <animate
      ...
      <circle cx="26" cy="10" r="6" className="fill-black">
        <animate
          attributeName="opacity"
          begin=".2"
          dur="1s"
      ...
      <circle cx="46" cy="10" r="6" className="fill-black">
        <animate
          attributeName="opacity"
          begin=".3"
          dur="1s"
...
export function SearchBottomIcon({ active = false }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
      <path
        className={`${active ? "stroke-black" : "stroke-gray-600"}`}
        strokeLinecap="round"
...
export function SettingsIcon({ active = false }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="none">
      <path
        className={`${active ? "fill-black" : "fill-gray-600"}`}
        fillRule="evenodd"
...
export function SearchIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
      <path
        className="stroke-white:stroke-black"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="2"
        d="M15.796 15.811 21 21m-3-10.5a7.5 7.5 0 1 1-15 0 7.5 7.5 0 0 1 15 0Z"
...
export function AddIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none">
      <path className="fill-white" d="M9 1a1 1 0 0 1 2 0v18a1 1 0 1 1-2 0V1Z" />
      <path
...
export function CalendarIcon({ active = false }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
      <path
        className={`${active ? "stroke-black" : "stroke-gray-600"}`}
